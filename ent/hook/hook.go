...
// function as Judge mutator.
type JudgeFunc func(context.Context, *ent.JudgeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f JudgeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.JudgeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.JudgeMutation", m)
}
